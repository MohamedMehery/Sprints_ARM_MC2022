...
*******************************************************************************/
uint8_t get_pulse_timing(Service_Device_Channel MasterDeviceChannel, Service_Device_Channel MasterStatusChannel, Service_Device_Channel SlaveDeviceChannel, Service_Device_Channel SlaveStatusChannel, Button_ButtonAttach_t ButtonAttach)
{
